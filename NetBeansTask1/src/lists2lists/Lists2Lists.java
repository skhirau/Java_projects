...
public class Lists2Lists extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(i != -1)
        {
            dlm2.addElement(dlm1.elementAt(i));
            dlm1.remove(i);
        }
        else
            JOptionPane.showMessageDialog(this,"No item has been selected yet.");
        return;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        for(int i = st.length - 1;i >= 0 ; i--)
        {
            dlm1.addElement(dlm2.elementAt(st[i]));
            dlm2.remove(st[i]);
        }
        return;
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(i != -1)
        {
            dlm1.addElement(dlm2.elementAt(i));
            dlm2.remove(i);
        }
        else
            JOptionPane.showMessageDialog(this,"No item has been selected yet.");
